...
async def send_post_one_chat(
    ...
    *,
    ...
    # ربط رسالة الأساس بالحملة بالتفاعلات (مهم لاحتساب الحملة)
    if sess.campaign_id is not None:
        try:
    ...
    # 🔹 هنا فقط: تركيب أزرار التفاعل مباشرة تحت منشور الأساس
    try:
        await context.bot.edit_message_reply_markup(
            chat_id=chat_id,
        ...
        # لو فشل (حالة نادرة)، نتجاهل الكيبورد ولا نكسر النشر
        pass
