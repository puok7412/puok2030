...
async def handle_reactions(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # أجب فورًا لتفادي "Query is too old..."
    try:
        await query.answer()
    except BadRequest:
        return
    ...
    # عدّل أزرار العدّاد على نفس رسالة الأزرار
    kb = InlineKeyboardMarkup([[
    ...
    # رسالة شكر مقتبسة من المنشور ليعود للأعلى
    try:
