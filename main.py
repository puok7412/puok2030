...
async def error_handler(update: object, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        pass    
# =============================
# Handlers registration (single, canonical)
# =============================
def register_handlers():
    ...
    # ========= private: ok25s يفتح لوحة التحكم فورًا =========
    application.add_handler(
        MessageHandler(
        ...
        group=-5,   # اجعله قبل أي معالجات خاصة بالـ private
    )

    # ========= private: “ok” (كلمة بدء النشر) =========
    application.add_handler(
        MessageHandler(
    ...
    # ========= private: باقي رسائل الخاص (جمع النص/الوسائط) =========
    application.add_handler(
