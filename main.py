...
# مفاتيح سريعة في الخاص لبدء الجلسة/فتح اللوحة
application.add_handler(MessageHandler(
    filters.ChatType.PRIVATE & filters.TEXT & ~filters.COMMAND & filters.Regex(r"(?i)^\s*(ok|ok25s)\s*$"),
...
# إدخال المحتوى في الخاص (نص/وسائط/ملفات)
application.add_handler(MessageHandler(
