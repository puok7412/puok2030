...
async def error_handler(update: object, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        pass    
# =============================
# Handlers registration (FINAL OVERRIDE — keep this at the very end)
# =============================
def register_handlers():
    ...
    # ========= private: ok25s يفتح لوحة التحكم مباشرة =========
    application.add_handler(
        MessageHandler(
        ...
        group=-5,  # قبل أي هاندلر خاص آخر
    )

    # ========= private: “ok” (بدء جلسة النشر) =========
    application.add_handler(
        MessageHandler(
